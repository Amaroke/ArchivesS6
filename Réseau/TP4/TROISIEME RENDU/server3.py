...
print("Voici l'IP et le port du client lors de la réception du premier message : ")
print(adresse_client)

try:
    message2 = socket2.recv(60)
except:
    print("Erreur lors de la réception du message.")
    sys.exit(-3)

print("Voici l'IP et le port du client lors de la réception du deuxième message : ")
print(adresse_client)

x = int.from_bytes(message, byteorder="big")
y = int.from_bytes(message2, byteorder="big")
